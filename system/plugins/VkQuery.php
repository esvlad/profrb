...
class VkQuery{
	...
	function __construct($data = null){
		...
		//$json = file_get_contents('https://oauth.vk.com/access_token' . '?' . urldecode(http_build_query($params)));
	...
	*/
	 ...
	 * при прикреплении изображения к сообщению 'message', по умолчанию 'wall'
