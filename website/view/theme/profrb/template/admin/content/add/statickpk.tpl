...
<form class="admin_form clearfix" method="post" action="index.php?r=admin/content/save&type=static" data-table="content" data-params="save">
    <input type="hidden" name="content_type_id" value="12">
    ...
    <p id="more_field" class="admin_more_docs" onclick="addField(36)" data-type-id="36" data-type="static_address" data-key="2">Добавить ещё адресный блок</p>
