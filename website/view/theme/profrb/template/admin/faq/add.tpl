<h2 class="modal_title">Добавление нового вопроса</h2>

<form class="admin_form clearfix" method="post" data-table="faq" data-params="save">
    ...
    <div class="admin_form_row">
      ...
      <p class="admin_form_caption">Введите текст вопроса, <b>обязательно для заполнения</b></p>
      <textarea id="question" name="question" data-table="faq" required></textarea>
    </div>
    <div class="admin_form_row">
      ...
      <input id="question_author_name" type="text" name="question_author_name" data-table="faq" value="" required/>
    </div>
    <div class="admin_form_row">
      ...
      <input id="question_author_from" type="text" name="question_author_from" data-table="faq" value="" required/>
    </div>
    <div class="admin_form_row">
      ...
      <input id="question_author_work" type="text" name="question_author_work" data-table="faq" value="" required/>
    </div>
    <div class="admin_form_row">
      <label for="question_author_mail">E-mail</label>
      <p class="admin_form_caption">E-mail автора вопроса</p>
      <input id="question_author_mail" type="text" name="question_author_mail" data-table="faq" value=""/>
    </div>
    <div class="admin_form_row">
      <label for="answer">Ответ</label>
      <p class="admin_form_caption">Введите текст ответа</p>
      <textarea id="answer" name="answer" data-table="faq"></textarea>
    </div>
    <div class="admin_form_row">
    ...
    <div class="admin_form_row">
      ...
      <p class="admin_form_caption">Не обязательное поле, используется для сортировки вопросов</p>
      <input id="date_creat" type="date" name="date_creat" data-table="faq" value=""/>
    </div>
    <div class="admin_form_row">
    ...
    <div class="admin_form_row">
      ...
      <label for="question_author_private">Автор получит ответ по почте</label>
      <p class="admin_form_caption">Отметьте, если автор вопроса должен получить ответ на указанную почту</p>
    </div>
    <div class="admin_form_row">
...
$('.admin_modal #save').click(function(e){
  ...
  if(!form_error){
    ...
    $.ajax({
      url: 'index.php?r=admin/faq/save',
      type: 'post',
      data: post_data,
      dataType: 'json',
