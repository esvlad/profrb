<h2 class="modal_title">Редактирование места работы</h2>
...
<form class="admin_form clearfix" method="post" data-table="calc" data-params="update">
    ...
    <div class="admin_form_row">
      ...
      <input id="name" type="text" name="name" data-table="calc_jobs" value="<?=$name;?>" required/>
    </div>
    <div class="admin_form_row">
      ...
      <input id="position" type="text" name="position" data-table="calc_jobs" value="<?=$position;?>"/>
    </div>
    <div class="admin_form_row">
      <? if($active == 1) : ?>
...
$('.admin_modal #edit').click(function(e){
  ...
  if(!form_error){
    ...
    $.ajax({
      url: 'index.php?r=admin/calculator/updateJob',
      type: 'post',
      data: post_data,
      dataType: 'json',
