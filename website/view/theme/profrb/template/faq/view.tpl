              ...
              <div class="faq_answer">
                ...
                <div class="faq_answer_cs">
                  <div class="social_icons faq_answer_cs__socials clearfix">
                    ...
                    <i class="social_icon" id="social_repost" data-social-type="vk" onclick="window.open('https://vk.com/share.php?url=<?='http://'. $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];?>&title=<?=$content['question'];?>','sharer','toolbar=0,status=0,width=700,height=400');"></i>
                    <i class="social_icon" id="social_repost" data-social-type="tw" onclick="window.open('http://twitter.com/share?url=<?='http://'. $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];?>&text=<?=$content['question'];?>','sharer','toolbar=0,status=0,width=700,height=400');"></i>
                    <i class="social_icon" id="social_repost" data-social-type="fb" onclick="window.open('https://www.facebook.com/sharer.php?u=<?='http://'. $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];?>&title=<?=$content['question'];?>&description=<?=strip_tags($content['answer']);?>','sharer','toolbar=0,status=0,width=700,height=400');"></i>
                    <i class="social_icon" id="social_repost" data-social-type="ok" onclick="window.open('https://connect.ok.ru/dk?st.cmd=WidgetSharePreview&st.description=<?=strip_tags($content['answer']);?>&st.title=<?=$content['question'];?>&st.shareUrl=<?='http://'. $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];?>','sharer','toolbar=0,status=0,width=700,height=400');"></i>
                  </div>
