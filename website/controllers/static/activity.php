<?php
class ControllerStaticActivity extends MVC{
	public function index($arg = array()){
		...
		$activity_model = new Action(MODEL, 'static/activity');
		$data['contents'] = $activity_model->loader('getContents', $arg['id']);

		return $this->render(THEME_NAME . '/template/static/activity.tpl', $data);
	}
}
?>